    ...
    def train(self, batch):
        ...
        with torch.no_grad():
            ...
            if isinstance(a2, tuple):
                a2 = a2[0]
            a2 = (a2 + noise).clamp(-self.model.actor.act_limit, self.model.actor.act_limit)
        ...
        loss_q.backward()
        torch.nn.utils.clip_grad_norm_(self.model.parameters(), max_norm=1.1)
        ...
        if self.update_counter % self.policy_delay == 0:
            ...
            loss_pi.backward()
            torch.nn.utils.clip_grad_norm_(self.model.actor.parameters(), max_norm=1.1)
        ...
        ret_dict = dict(
            loss_actor=loss_pi.detach().item() if self.update_counter % self.policy_delay == 0 else None,
